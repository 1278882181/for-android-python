...
public class Constants {
    ...
    public static  final String login_url = "http://172.20.100.2:8080/user/login";

    public static final String signup_url= "http://172.20.100.2:8080/user/add";

    public static final String BASE_URL = "http://172.20.118.102:8000";

    /**
     * 基础广告地址
     */
    public static final String BASE_ADS_URL = "http://172.20.118.102:8000";
   ...
   // public static final String REGISTER_URL = "/control/register";
    public static final String REGISTER_URL = "/1.jpg";
     ...
     * 商品类型接口Url
     */
    public static final String GET_COMMODITY_TYPES_URL = "/1.jpg";//"/business/queryCommodityTypes";

    /**
     * 分页获取商品列表Url
     */
    public static final String GET_COMMODITY_URL = "/test1.json";//"/business/queryPage";
